        ...
        <div class="w-screen pl-8 2xl:pl-[calc((100%-1410px)/2)]">
            <div
                ...
                <div class="relative z-20 text-white w-full md:max-w-[922px]">
                    <SectionTitle title="Step inside our world - where elegance is redefined through every detail."
                        class=" uppercase mb-4 md:mb-6 lg:!leading-[73px] " />
                    <p class="text-base md:text-xl lg:text-3xl font-normal w-full text-white">
                        Have any questions about distretto ? Don’t hastate to reach out
                    </p>
